...
var i=t.default
e.default=i}),define("octoshark-music/index",[],function(){}),define("octoshark-music/initializers/app-version",["exports","ember-cli-app-version/initializer-factory","octoshark-music/config/environment"],function(e,t,i){var r,a
...
var i=t.default.Model.extend({name:t.default.attr("string"),description:t.default.attr("string"),date:t.default.attr("timestamp"),locationName:t.default.attr("string")})
...
var t=Ember.HTMLBars.template({id:"z7RTMtF+",block:'{"symbols":["events"],"statements":[[4,"each",[[24,["model"]]],null,{"statements":[[0,"    "],[7,"div",true],[8],[1,[23,1,["name"]],false],[9],[0,"\\n    "],[7,"div",true],[8],[1,[23,1,["date"]],false],[9],[0,"\\n    "],[7,"div",true],[8],[1,[23,1,["description"]],false],[9],[0,"\\n    "],[7,"div",true],[8],[1,[23,1,["locationName"]],false],[9],[0,"\\n    "],[7,"div",true],[8],[1,[23,1,["image"]],false],[9],[0,"\\n"]],"parameters":[1]},null]],"hasEval":false}',meta:{moduleName:"octoshark-music/templates/events.hbs"}})
...
return Object.defineProperty(i,"__esModule",{value:!0}),i}catch(r){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("octoshark-music/app").default.create({name:"octoshark-music",version:"0.0.0+8eabb6e4"})
