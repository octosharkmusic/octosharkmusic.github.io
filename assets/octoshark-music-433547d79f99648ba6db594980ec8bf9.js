"use strict"
define("octoshark-music/adapters/application",["exports","emberfire/adapters/firebase"],function(e,i){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=i.default.extend({})
e.default=t}),define("octoshark-music/app",["exports","octoshark-music/resolver","ember-load-initializers","octoshark-music/config/environment"],function(e,i,t,r){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
return Object.defineProperty(t,"__esModule",{value:!0}),t}catch(r){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("octoshark-music/app").default.create({name:"octoshark-music",version:"0.0.0+b7eb27c4"})
