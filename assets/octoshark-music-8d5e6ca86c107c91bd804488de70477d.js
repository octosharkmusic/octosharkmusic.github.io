...
var t=Ember.HTMLBars.template({id:"IUY4E6g+",block:'{"symbols":[],"statements":[[0,"yo"]],"hasEval":false}',meta:{moduleName:"octoshark-music/templates/application.hbs"}})
...
return Object.defineProperty(i,"__esModule",{value:!0}),i}catch(a){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("octoshark-music/app").default.create({name:"octoshark-music",version:"0.0.0+a9cd00c1"})
